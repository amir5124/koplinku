...
function getExpiredTimestamp() {
    ...
    const now = new Date();
    // Tambahkan 15 menit (15 * 60 * 1000 milidetik)
    const expiryTime = now.getTime() + (15 * 60 * 1000);
    // Kembalikan waktu dalam format Unix timestamp (dalam detik)
...
app.post('/create-va', async (req, res) => {
    ...
    try {
        ...
        const expired = getExpiredTimestamp(); // Waktu kedaluwarsa dalam Unix timestamp
        ...
        // Perbaikan: Pastikan FROM_UNIXTIME() digunakan dengan benar pada expired_at
